...
def explore_data(df_guest_train, df_guest, df_booking):
    ...
    # Boxenplot of EnquiryN, QuoteN, BookN by SegmentTitle
    ...
    #Boxenplot of Days by SegmentTitle
    ...
    # Boxenplot of CommercialValueGBP by SegmentTitle
    plt.grid(axis = 'y', linestyle = '-', alpha = 0.3)
